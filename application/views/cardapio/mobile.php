...
<body>
	...
	<div class="app-main">
		...
		<div class="section tab_contents_container">
			<!-- <div id="seg" class="tab_contents tab_contents_active fade"> -->
				...
				<div class="content_tab_main">
					<div class="fieldset">
						<div class="legend"><?= $dados['DC_OPCAO']; ?></div>
						<span><?= $dados['SEG_DESC']; ?></span>
					</div>	
				</div>
				<?php 
			...
			<div id="ter" class="tab_contents fade">
				...
				<div class="content_tab_main">
					<div class="fieldset">
						<div class="legend">Principal</div>
						<span>Achocolatado/Suco</span>
					</div>

					<div class="fieldset">
						<div class="legend">Acompanhamento</div>
						<span>Tapioquinha Simples</span>
					</div>					
				</div>
				...
				<div class="content_tab_main">
					<div class="fieldset">
						<div class="legend">Prato Principal</div>
						<span>Coxa e sobrecoxa assadas</span>
					</div>

					<div class="fieldset">
						<div class="legend">Opção</div>
						<span>Carne moída a Bolonhesa</span>
					</div>					

					<div class="fieldset">
						<div class="legend">Prato Base</div>
						<span>Arroz Branco e Feijão Carioca</span>
					</div>					

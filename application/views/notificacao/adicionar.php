...
<body>
                ...
                <div class="section-box padding">
                    <form id="submit" class="wrapper">
                            ...
                            <div class="button-wrapper">
                                ...
                                <input type="file" name="file" id="file" placeholder="Upload do Arquivo">
                            </div>
                            <button type="submit" id="btn_upload">Enviar Arquivo</button>
    ...
    <script>
        ...
        let hora = date2.getHours().toString().padStart(2, '0');
        let minuto = date2.getMinutes().toString().padStart(2, '0');
       ...
       $("#submit").submit(function(e){
            ...
            var html = `<a href="https://seculomanaus.com.br/componentes/portal/arquivos/${ano}${mes}${dia}_${hora}${minuto}${file.name}" target="_blank"><i class="far fa-file-pdf"></i> ${ano}${mes}${dia}_${hora}${minuto}${file.name}</a>`;
            $("#file_name").val(ano+mes+dia+"_"+hora+minuto+file.name);
            $("#anexo").attr("value",ano+mes+dia+"_"+hora+minuto+file.name);


            $("#anexo-arquivo").html(html);

            e.preventDefault();        
            $.ajax({
                url: "<?= base_url(); ?>notificacao/adicionar/do_upload", 
                type: "POST",

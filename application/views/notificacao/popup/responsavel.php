<div class="row content-box-main">
    <div class="row-x table-header-box">
        <div class="col-2"><strong>Selecione o Responsável</strong> <br><p><em>Respons&aacute;vel financeiro destaque em&nbsp;<span style="color: #0000ff;">azul</span></em></p></div>
    	<div class="col-2">
...
<?php   if(!empty($info_responsavel['FIN'])) {  ?>
        			...
        			<span style="color: #0000ff;"><?= $info_responsavel['NM_RESPONSAVEL']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Cel: &nbsp; <?= $info_responsavel['CEL_RESPONSAVEL']; ?>
